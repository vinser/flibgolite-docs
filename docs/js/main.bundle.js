...
function initIndex() {
  ...
  index.add(
      ...
      
      {
        id: 3,
        tag: "en",
        href: "/hugo-hinode/apps/flibgolite/",
        title: "FLibGoLite",
        description: "Just enough for free OPDS server",
        
        
        content: "FLibGoLite is easy to use lightweight home library server with OPDS catalog.\n\u0026nbsp; The OPDS catalog format is a syndication format for electronic publications based on Atom and HTTP. OPDS catalogs enable the aggregation, distribution, discovery, and acquisition of electronic publications. (Wikipedia) FLibGoLite is multiplatform and can run on Windows, macOs and Linux. It uses SQLite database for book search index.\nCurrent FLibGoLite release supports EPUB and FB2 (single files and zip archives) publications format.\nFLibGoLite OPDS catalog has been tested and works with mobile book reader applications PocketBook Reader, FBReader, Librera Reader, Cool Reader, as well as desktop applications Foliate and Thorium Reader. You can use any other applications or e-ink devices that can read the listed book formats and work with OPDS catalogs.\nFLibGoLite program is written in GO as a single executable file and doesn\u0026rsquo;t require any prereqiusites.\nAll you have to do is to download, install and start it. Detailed instructions on how to do this can be found on the product website\u0026nbsp; Enjoy!"
      })
      .add(
      ...
      
      {
        id: 5,
        tag: "en",
        href: "/hugo-hinode/apps/pixyne/",
        title: "Pixyne",
        description: "Quick photo picker",
        
        
        content: "_\nPixyne is an application that allows you to quickly review your photo folders, safely delete bad and similar shots, fix the shooting dates, crop and ajust photos.\nPixyne application has a simple and intuitive interface:\nWith a click on photo you can mark to drop it in the trash. In Advanced mode you may also set or correct the EXIF shooting date crop the size and ajust selected photo. When you save changes, you can change all file names to EXIF shooting date format. Changes will not be applied until you save. Pixyne automaticaly stores the current state of the folder so you can undo changes at any time. This is useful when working with a large number of photos and you need to close the application in order to continue working later and resume from the same place. All you have to do is to download, install and start it. Detailed instructions on how to do this can be found on the product website\u0026nbsp; Enjoy!"
      })
      .add(
